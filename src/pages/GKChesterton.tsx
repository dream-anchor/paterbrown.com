  ...
  return (
    ...
    >
      ...
      <Section container="wide" className="py-20 md:py-32">
        <div className="grid md:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-4">
            ...
            <p className="text-foreground/30 text-xs font-serif">
              Foto: Library of Congress, LC-DIG-ggbain-03654 (Public Domain)
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section container="narrow" className="py-20 md:py-32">
        <p className="text-primary text-xs uppercase tracking-[0.3em] font-heading mb-4">Werk</p>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading text-foreground mb-4">
          Chestertons Werk
        </h2>
        <div className="divider-gold mb-8 max-w-xs" aria-hidden="true" />
        ...
        <div className="space-y-3">
          {WORKS.map((work) => (
            <div key={work.year} className="card-glow rounded-[3px] p-5">
              <div className="flex items-baseline justify-between gap-4">
                <p className="font-heading text-foreground">{work.title}</p>
                <span className="text-primary text-sm font-heading whitespace-nowrap">{work.year}</span>
              </div>
              <p className="text-foreground/50 text-sm font-serif mt-1">{work.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="card-glow rounded-[3px] overflow-hidden">
            <img
              ...
              loading="lazy"
            />
            <p className="text-foreground/30 text-xs font-serif p-3">1904 – junger Autor</p>
          </div>
          <div className="card-glow rounded-[3px] overflow-hidden">
            <img
              ...
              loading="lazy"
            />
            <p className="text-foreground/30 text-xs font-serif p-3">Am Schreibtisch</p>
          </div>
          <div className="card-glow rounded-[3px] overflow-hidden">
            <img
              ...
              loading="lazy"
            />
            <p className="text-foreground/30 text-xs font-serif p-3">Mit Shaw &amp; Belloc</p>
          </div>
        </div>
        <p className="text-foreground/20 text-xs font-serif mt-4 text-center">
          Fotos: Wikimedia Commons / Library of Congress (Public Domain)
        </p>
      </Section>
      ...
      {/* Zitate */}
      <Section container="narrow" className="py-20 md:py-32">
        <p className="text-primary text-xs uppercase tracking-[0.3em] font-heading mb-4">Stimmen</p>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading text-foreground mb-4">
          Über Chesterton
        </h2>
        ...
        <div className="space-y-12">
          <Quote
            text="Chesterton ist so heiter, dass man meinen könnte, er habe die Lösung gefunden."
            citation="Franz Kafka"
          />
          <div className="divider-gold max-w-[4rem] mx-auto" aria-hidden="true" />
          <Quote
            text="Chesterton war einer der wenigen wirklich großen Autoren unserer Zeit."
            citation="Jorge Luis Borges"
          />
          <div className="divider-gold max-w-[4rem] mx-auto" aria-hidden="true" />
          <Quote
            text="Er war der brillanteste Krimiautor seiner Generation."
            citation="P.D. James"
          />
        </div>
      </Section>
      ...
      {/* Erbe heute */}
      <Section container="narrow" className="py-20 md:py-32">
        <p className="text-primary text-xs uppercase tracking-[0.3em] font-heading mb-4">Erbe</p>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading text-foreground mb-4">
        ...
        <SerifText size="lg" className="text-foreground/70 mb-8">
          ...
          Mehr zu den{" "}
          <Link to="/hoerspiel" className="text-primary hover:text-primary/80 transition-colors underline-offset-4 hover:underline">
