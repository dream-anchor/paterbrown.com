...
const GRADIENT_BG = "linear-gradient(135deg, hsl(28 100% 55%), hsl(28 90% 45%))";
...
const StickyMobileCTA = () => {
  ...
  return (
    ...
    >
      ...
      {/* iOS toolbar-gap cover: gradient extends below viewport */}
      <div
        className="absolute left-0 right-0"
        style={{ top: "100%", height: "100px", background: "inherit" }}
        aria-hidden="true"
      />
    </div>
  );
