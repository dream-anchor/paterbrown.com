    ...
    <div className="stoerer-banner py-3 md:py-4 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6 relative z-10">
        <div className="flex items-center gap-2 md:gap-3">
          <Zap className="w-5 h-5 md:w-7 md:h-7 text-black fill-neon-gold animate-pulse" />
        ...
        <div className="flex items-center gap-2">
          <Flame className="w-7 h-7 md:w-9 md:h-9 text-neon-gold fill-neon-gold animate-pulse" />
        ...
        {timeLeft && (
          <div className="flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-black/90 border-2 border-neon-gold shadow-lg">
            <Clock className="w-4 h-4 md:w-5 md:h-5 text-neon-gold animate-pulse" />
